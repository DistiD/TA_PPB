...
import 'package:muslim_app/screens/splash_screen.dart'; // Import file splash_screen.dart
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return MaterialApp(
          ...
          routes: {
            SplashScreen.routeName: (_) => SplashScreen(), // Tambahkan route untuk SplashScreen
          ...
          initialRoute: SplashScreen.routeName, // Tentukan SplashScreen sebagai initial route
        );
      },
    );
  }
